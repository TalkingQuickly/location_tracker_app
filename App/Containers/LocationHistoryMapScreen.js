...
class LocationHistoryMapScreen extends React.Component {
  /* ***********************************************************
  ...
  *************************************************************/
  ...
  getPoints() {
    this.props.attemptGetRecentLocations()
  }
...
const mapStateToProps = (state) => {
  return {
    fetching: state.locationHistoryMap.fetching,
    locations: state.locationHistoryMap.recentLocations
...
const mapDispatchToProps = (dispatch) => {
  return {
    attemptGetRecentLocations: () => dispatch(LocationHistoryMapActions.recentLocationsRequest())
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(LocationHistoryMapScreen)
